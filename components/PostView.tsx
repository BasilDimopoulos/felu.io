        ...
        <div className="mb-24 lg:flex">
            <div className="card-body lg:w-1/3 md:pr-10">
                ...
                <Link href={'/blog/' + post.slug} passHref key={index}>
                    <h4 className="md:text-5xl text-3xl uppercase font-anton text-[#1D2126] pt-2 pb-2">{post.frontMatter.title}</h4>
                </Link>
            ...
            <div className="lg:w-2/3">
                <Link href={'/blog/' + post.slug} passHref key={index}>
                    <img alt="blog_image" src={post.frontMatter.thumbnailUrl}
                    ></img>
                </Link>
            </div>
        </div>
